...
const Adventure = ({ data, showAllGames = false }: AdventureProps) => {
  const adventureGames = getFilteredGame(data, "Adventure");
  ...
  const visibleItems = showAll ? adventureGames : adventureGames.slice(0, 8);
